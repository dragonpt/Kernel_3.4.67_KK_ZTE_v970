#ifndef _LINUX_ATMEL_TS_H
#define _LINUX_ATMEL_TS_H
  
#include  <linux/types.h>

    #define   ATMEL_MXT_TS_NAME                   "atmel_mxt_ts"
  ...
  /* Object types */
    ...
    #define   DIAGNOSTIC_T37                      37u   /* Debug diagnostic */
    #define   SPT_USERDATA_T38                    38u
    #define   PROCI_GRIP_T40                      40u 
    #define   PROCI_PALM_T41                      41u
...
//>2011/06/08-joshualee.
    ...
    //<05/24-joshualee, for multiple touchpanel in STE
    //bool      regulator_en;
    //>05/24-joshualee.
    };
