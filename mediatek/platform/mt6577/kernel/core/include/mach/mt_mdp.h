...
/*/////////////////////////////////////////////////////////////////////////////
    Definnition
  /////////////////////////////////////////////////////////////////////////////*/
#define MT_MDP_DEV_MAJOR_NUMBER 252
#define MT_MDPMAGICNO 'g'
...
#define MT_MDP_BUFFCNT 16
typedef struct {
    unsigned long mdp_id;
    unsigned long sec[MT_MDP_BUFFCNT];
    unsigned long usec[MT_MDP_BUFFCNT];
} stTimeStamp;
...
/*/////////////////////////////////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////////////////////////*/
//Lock NODES
#define MT_MDP_T_LOCKRESOURCE _IOWR(MT_MDPMAGICNO,0,stLockResParam)

//Unlock NODES
#define MT_MDP_T_UNLOCKRESOURCE _IOW(MT_MDPMAGICNO,1,int)

//Wait IRQ
#define MT_MDP_X_WAITIRQ _IOW(MT_MDPMAGICNO,2,stWaitIrqParam)

//Clear IRQ flag
#define MT_MDP_T_CLRIRQ _IOW(MT_MDPMAGICNO,3,int)

//Dump registers
#define MT_MDP_T_DUMPREG _IO(MT_MDPMAGICNO,4)

//Get ROTDMA0 time stamp
#define MT_MDP_G_TIMESTAMP _IOR(MT_MDPMAGICNO , 5 , stTimeStamp)

//Get pmem range
#define MT_MDP_G_PMEMRANGE _IOR(MT_MDPMAGICNO , 6 , stPMEMRange)

//Set zoom ratio
#define MT_MDP_T_SETZOOM _IOR(MT_MDPMAGICNO , 7 , stZoomSetting)

/*-----------------------------------------------------------------------------
    MDP Kernel Mode API
  -----------------------------------------------------------------------------*/
//MDPK Bitblit
#define MDPK_BITBLT_G_WAIT_REQUEST  _IOR(MT_MDPMAGICNO , 8 , MDPIOCTL_MdpkBitbltConfig)
#define MDPK_BITBLT_T_INFORM_DONE   _IOW(MT_MDPMAGICNO , 9 , MDPIOCTL_MdpkBitbltInformDone)
/*-----------------------------------------------------------------------------*/

//Set ZSD zoom ratio
#define MT_MDP_T_SETZSDZOOM _IOW(MT_MDPMAGICNO , 10 , stZSDZoomReg)

/*-----------------------------------------------------------------------------
    MDP MVA Register loop memory tracker
  -----------------------------------------------------------------------------*/
#define MT_MDP_T_MVALOOPMEMTRACK _IOWR(MT_MDPMAGICNO,11,MDPIOCTL_MvaLoopMemTrack)

// last preview frame for zsd
#define MT_MDP_T_SETZSDPREVIEWFRAME _IOW(MT_MDPMAGICNO , 12 , stZSDPreviewReg)

// Get CPU Clock
#define MDPIO_T_CPUCLOCKGET _IOR(MT_MDPMAGICNO , 13 , MDPIOCTL_CpuClockGet )
...
#define MT_RDMA_IRQ_FLAG_ADDR(i)                (i)
#define MT_RDMA_IRQ_FLAG_CLR_ADDR(i)            (i + 0x08)
#define MT_RDMA_QUEUE_RSTA_ADDR(i)	            (i + 0x40)
#define MT_RDMA_EXEC_CNT_ADDR(i)                (i + 0x80)


#define MT_ROT_DMA_IRQ_FLAG_ADDR(i)             (i)
#define MT_ROT_DMA_IRQ_FLAG_CLR_ADDR(i)         (i + 0x08)
#define MT_ROT_DMA_CFG_ADDR(i)                  (i + 0x18)
#define MT_ROT_DMA_LOCK_ADDR(i)                 (i + 0x3C)
#define MT_ROT_DMA_QUEUE_RSTA_ADDR(i)           (i + 0x40)
#define MT_ROT_DMA_RD_BASE_ADDR(i)              (i + 0x48)
#define MT_ROT_DMA_RPT_ADVANCE_ADDR(i)          (i + 0x50)
#define MT_ROT_DMA_QUEUE_WSTA_ADDR(i)           (i + 0x58)
#define MT_ROT_DMA_QUEUE_BASE_ADDR(i)           (i + 0x78)
#define MT_ROT_DMA_QUEUE_DATA_ADDR(i)           (i + 0x70)
#define MT_ROT_DMA_EXEC_CNT_ADDR(i)             (i + 0x80)
#define MT_ROT_DMA_DROPPED_FRAME_CNT_ADDR(i)    (i + 0x88)

#define MT_RZ_INFO0(i)                          (i + 0x00B0) // only CRZ
#define MT_RZ_INFO1(i)                          (i + 0x00B4) // only CRZ
#define MT_RZ_CFG_ADDR(i)                       (i + 0x0000)
#define MT_RZ_STA_ADDR(i)                       (i + 0x0008)
#define MT_RZ_INT_ADDR(i)                       (i + 0x000C)
#define MT_RZ_SRCSZ_ADDR(i)                     (i + 0x0010)
#define MT_RZ_TARSZ_ADDR(i)                     (i + 0x0014)
#define MT_RZ_HRATIO_ADDR(i)                    (i + 0x0018)
#define MT_RZ_VRATIO_ADDR(i)                    (i + 0x001C)
#define MT_RZ_LOCK_ADDR(i)                      (i + 0x0020)
#define MT_RZ_CROPLR_ADDR(i)                    (i + 0x00F4)
#define MT_RZ_CROPTB_ADDR(i)                    (i + 0x00F8)


#define MT_VRZ_CFG_ADDR(i)                      (i + 0x00)
#define MT_VRZ_INT_ADDR(i)                      (i + 0x0C)
#define MT_VRZ_HRES_ADDR(i)                     (i + 0x20)
#define MT_VRZ_VRES_ADDR(i)                     (i + 0x24)
//#define MT_VRZ_FRCFG_ADDR(i)                  (i + 0x40)


#define MT_JPEG_DMA_CON_ADDR(i)                 (i + 0x0C)
#define MT_JPEG_DMA_INTERRUPT_ADDR(i)           (i + 0x20)

#define MT_BRZ_INT_ADDR(i)                      (i + 0x08)

#define MT_OVL_DMA_IRQ_FLAG_ADDR(i)             (i)
#define MT_OVL_DMA_IRQ_FLAG_CLR_ADDR(i)         (i + 0x08)


/*Copy From MT6577MDPReg.h*/
#define MT_MMSYS1_REG_RANGE    0x230

#define MT_RDMA0_REG_RANGE 0x3D0
#define MT_RDMA1_REG_RANGE 0x3D0

#define MT_BRZ_REG_RANGE    0x34

#define MT_CRZ_REG_RANGE    0xFC
#define MT_PRZ0_REG_RANGE   0xFC
#define MT_PRZ1_REG_RANGE   0xFC

#define MT_VRZ0_REG_RANGE      0xB8
#define MT_VRZ1_REG_RANGE      0xB8

#define MT_IPP_REG_RANGE        0x32C
#define MT_OVL_DMA_REG_RANGE    0x14C

#define MT_RGB_ROT0_REG_RANGE           0x434
#define MT_RGB_ROT1_REG_RANGE           0x434
#define MT_RGB_ROT2_REG_RANGE           0x434
#define MT_VDO_ROT0_REG_RANGE           0x434
#define MT_VDO_ROT1_REG_RANGE           0x434

#define MT_JPEG_DMA_REG_RANGE      0xB0
