...
#ifndef _MT6577_THERMAL_H
#define _MT6577_THERMAL_H
 ...
 ******************************************************************************/
#define AUXADC_CON0_V       (AUXADC_BASE + 0x000)
...
#define AUXADC_DAT0_V       (AUXADC_BASE + 0x018)
#define AUXADC_DAT1_V       (AUXADC_BASE + 0x01C)
#define AUXADC_DAT2_V       (AUXADC_BASE + 0x020)
#define AUXADC_DAT3_V       (AUXADC_BASE + 0x024)
#define AUXADC_DAT4_V       (AUXADC_BASE + 0x028)
#define AUXADC_DAT5_V       (AUXADC_BASE + 0x02C)
#define AUXADC_MISC_V       (AUXADC_BASE + 0x094)

#define AUXADC_CON0_P       (AUXADC_BASE + 0x000 - 0x30000000)
#define AUXADC_CON1_P       (AUXADC_BASE + 0x004 - 0x30000000)
#define AUXADC_CON1_SET_P   (AUXADC_BASE + 0x008 - 0x30000000)
#define AUXADC_CON1_CLR_P   (AUXADC_BASE + 0x00C - 0x30000000)
#define AUXADC_CON2_P       (AUXADC_BASE + 0x010 - 0x30000000)
#define AUXADC_CON3_P       (AUXADC_BASE + 0x014 - 0x30000000)
#define AUXADC_DAT0_P       (AUXADC_BASE + 0x018 - 0x30000000)
#define AUXADC_DAT1_P       (AUXADC_BASE + 0x01C - 0x30000000)
#define AUXADC_DAT2_P       (AUXADC_BASE + 0x020 - 0x30000000)
#define AUXADC_DAT3_P       (AUXADC_BASE + 0x024 - 0x30000000)
#define AUXADC_DAT4_P       (AUXADC_BASE + 0x028 - 0x30000000)
#define AUXADC_DAT5_P       (AUXADC_BASE + 0x02C - 0x30000000)
#define AUXADC_MISC_P       (AUXADC_BASE + 0x094 - 0x30000000)
 ...
 ******************************************************************************/
#define TEMPMONCTL0         (THERMAL_BASE + 0x000)
