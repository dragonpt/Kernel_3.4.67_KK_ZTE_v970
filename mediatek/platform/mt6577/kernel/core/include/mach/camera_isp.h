...
#define ISP_INT_AF_DONE         ((u32)0x1 << 6)
...
typedef struct mt_isp_PQIndex_s {
    unsigned long u4SkinToneIndex;
    unsigned long u4GrassToneIndex;
    unsigned long u4SkyToneIndex;
    unsigned long u4YCCGOIndex;
    unsigned long u4EEIndex;
} mt_isp_PQIndex_t;
/*******************************************************************************
*
********************************************************************************/
typedef enum
{
    ...
    ISP_IOC_CMD_SET_PQ_PARAM,
    ISP_IOC_CMD_SET_PQ_PARAM_INIT,
    ISP_IOC_CMD_GET_PQ_PARAM
}ISP_IOC_CMD_ENUM;
...
//
#define MT_ISP_IOC_S_SET_PQ_PARAM       _IOW(ISP_MAGIC , ISP_IOC_CMD_SET_PQ_PARAM,       mt_isp_PQIndex_t)
//
#define MT_ISP_IOC_S_SET_PQ_PARAM_INIT  _IOW(ISP_MAGIC, ISP_IOC_CMD_SET_PQ_PARAM_INIT,       mt_isp_PQIndex_t)
//
#define MT_ISP_IOC_S_GET_PQ_PARAM       _IOR(ISP_MAGIC , ISP_IOC_CMD_GET_PQ_PARAM,       mt_isp_PQIndex_t)
