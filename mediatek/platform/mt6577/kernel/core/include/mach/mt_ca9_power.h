#ifndef __MT_CA9_POWER_H__
#define __MT_CA9_POWER_H__
...
extern int mt_ca9_power_ctrl(const CA9_CLK_GATING_CTRL ctrl);
extern int mt_l2c_power_ctrl(const L2C_POWER_CTRL ctrl);

#endif  /* !__MT_CA9_POWER_H__ */
