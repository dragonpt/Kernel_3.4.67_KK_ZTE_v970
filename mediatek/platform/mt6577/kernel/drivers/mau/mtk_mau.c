...
static int mau_probe(struct platform_device *pdev)
{
    ...
    if(request_irq(MT_SMI_LARB0_VAMAU_IRQ_ID , (irq_handler_t)mau0_isr, IRQF_TRIGGER_LOW, "MAU0-1" , NULL))
    {
    ...
    if(request_irq(MT_SMI_LARB2_VAMAU_IRQ_ID , (irq_handler_t)mau2_isr, IRQF_TRIGGER_LOW, "MAU2" , NULL))
    {
    ...
    if(request_irq(MT_LARB3_VAMAU_IRQ_ID , (irq_handler_t)mau3_isr, IRQF_TRIGGER_LOW, "MAU3" , NULL))
    {
