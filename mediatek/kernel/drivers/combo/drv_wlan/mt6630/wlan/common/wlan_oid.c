    ...
    /* 0xFFFE          reserved for FW */
        ...
        case 0x1001:
            if(u2SubId == 0x0) {
                ...
                GET_BSS_INFO_BY_INDEX(prAdapter, u4Data>>16)->rPmProfSetupInfo.ucBmpDeliveryAC = (UINT_8)prAdapter->u4UapsdAcBmp;
                GET_BSS_INFO_BY_INDEX(prAdapter, u4Data>>16)->rPmProfSetupInfo.ucBmpTriggerAC = (UINT_8)prAdapter->u4UapsdAcBmp;
            }
            else if(u2SubId == 0x4) {
...
//        *(PPARAM_POWER_MODE) pvQueryBuffer = (PARAM_POWER_MODE)(prAdapter->rWlanInfo.ePowerSaveMode.ucPsProfile);
        *(PPARAM_POWER_MODE) pvQueryBuffer = (PARAM_POWER_MODE)(prAdapter->rWlanInfo.arPowerSaveMode[prAdapter->prAisBssInfo->ucBssIndex].ucPsProfile);
    ...
    )
{
    ...
    *pu4SetInfoLen = 0;
    ...
    prCmdNetworkAddressList->ucBssIndex = prAdapter->prAisBssInfo->ucBssIndex;
