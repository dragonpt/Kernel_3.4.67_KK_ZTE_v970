...
Shading:{
    {set:{//00 Preview
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0x9050903C,0x00583C00,0x0052003F,0x20202020,
    }},
    {set:{//01 Capture
        0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x10000000,0xF064F04B,0x005C8540,0x0066004E,0x20202020,
    }},
    {set:{//02
...
Saturation:{
    {set:{//00 (middle saturation)
        0x00010709, 0x1020E0F0, 0x28505250, 0x28000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//01 (middle saturation)
        0x00010709, 0x1020E0F0, 0x28505250, 0x28000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//02 (middle saturation)
        0x00010709, 0x1020E0F0, 0x204A4C4A, 0x20000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//03 (middle saturation)
        0x00010709, 0x1020E0F0, 0x1C464846, 0x1C000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//04 (middle saturation)
        0x00010709, 0x1020E0F0, 0x1A404240, 0x1A000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//05 no one uses this, this is Min Sat. (low saturation)
        0x00000709, 0x1020E0F0, 0x1A343434, 0x1A000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//06 no one uses this, this is Max Sat. (high saturation)
        0x00000709, 0x1020E0F0, 0x32585A58, 0x32000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }}
}, 
Contrast:{
    //..........................................................................
...
CCM:{
    {set:{//00
        0x0164043E, 0x0426043D, 0x01140029, 0x040304A6, 0x01A90000, 
    }},
    {set:{//01
        0x01AF0498, 0x04170453, 0x011F0034, 0x040204A4, 0x01A60000, 
    }},
    {set:{//02
        0x01A70461, 0x04460430, 0x01440414, 0x00010472, 0x01710000, 
    }}
},
Gamma:{
    {set:{//00
