...
NR1:{
    ...
    {set:{//05 Capture ISO100
        0x000006E7, 0x000011B4, 0x092328C8, 0x0000068A, 0x09090303, 0x04050606, 0x06060303, 
        0x04050505, 0x06060303, 0x04050505, 0x09090303, 0x04050606, 0x0206090D, 0x10101010, 
    }},
    {set:{//06 Capture ISO200
        0x000006E7, 0x000011A0, 0x092428C8, 0x0000068A, 0x09090303, 0x04050606, 0x06060303, 
        0x04050505, 0x06060303, 0x04050505, 0x09090303, 0x04050606, 0x0206090D, 0x10101010, 
    }}, 
    {set:{//07 Capture ISO400
        0x000006E7, 0x000011A0, 0x092728C8, 0x000008AC, 0x0C0C0505, 0x07090A0A, 0x0C0C0505, 
        0x07090A0A, 0x0C0C0505, 0x07090A0A, 0x0C0C0505, 0x07090A0A, 0x0206090D, 0x10101010, 
    }},
    {set:{//08 Capture ISO800
        0x000006E7, 0x000011A0, 0x092C28C8, 0x000008AC, 0x0C0C0707, 0x090A0C0C, 0x0C0C0707, 
        0x090A0C0C, 0x0C0C0707, 0x090A0C0C, 0x0C0C0707, 0x090A0C0C, 0x0206090D, 0x10101010, 
    }},
...
EE:{//EE
    {set:{//00 Preview ISO100 (middle sharpness)
        0x00000008, 0x003C3C2D, 0x00500223, 0x0384203C, 0x0258F964, 0x003C00DC, 0xFFFFFF0B, 
    }},
    {set:{//01 Preview ISO200 (middle sharpness)
        0x00000008, 0x003C3C2D, 0x003C0123, 0x03201D3C, 0x01F4F964, 0x003C00DC, 0xFFFFFF0B, 
    }},
    {set:{//02 Preview ISO400 (middle sharpness)
        0x00000008, 0x0037372D, 0x00280123, 0x0258163C, 0x0190FB64, 0x002800DC, 0xFFFFFF0B, 
    }},
    {set:{//03 Preview ISO800 (middle sharpness)
        0x00000008, 0x0032322D, 0x00140023, 0x0266173C, 0x0133F964, 0x002900DC, 0xFFFFFF0B, 
    }},
    {set:{//04 Preview ISO1600 (middle sharpness)
        0x00000008, 0x0032322D, 0x00140023, 0x0266173C, 0x0133F964, 0x002900DC, 0xFFFFFF0B, 
    }},
    {set:{//05 Capture ISO100 (middle sharpness)
        0x0000000A, 0x0032322D, 0x00500223, 0x0384203C, 0x0258F964, 0x003C00DC, 0xFFFFFF0B, 
    }},
    {set:{//06 Capture ISO200 (middle sharpness)
        0x0000000C, 0x0032322D, 0x003C0123, 0x03201D3C, 0x01F4F964, 0x003C00DC, 0xFFFFFF0B, 
    }},
    {set:{//07 Capture ISO400 (middle sharpness)
        0x00000008, 0x0032322D, 0x00280123, 0x0258183C, 0x0190F864, 0x0028FEDC, 0xFFFFFF0B, 
    }},
    {set:{//08 Capture ISO800 (middle sharpness)
        0x00000006, 0x0032322D, 0x00140123, 0x0190183C, 0x00C8F864, 0x0014FEDC, 0xFFFFFF0B, 
    }},
    {set:{//09 Capture ISO1600 (middle sharpness)
        0x00000004, 0x0032322D, 0x00140123, 0x012C183C, 0x00C8F864, 0x0014FEDC, 0xFFFFFF0B, 
    }},
    ...
    {set:{//11 no one uses this, this is Max EE (high sharpness)
        0x0000000F, 0x0032322D, 0x00140023, 0x0266173C, 0x0133F964, 0x002900DC, 0xFFFFFF0B, 
    }}
}, 
Saturation:{
    ...
    {set:{//01 (middle saturation)
        0x00000709, 0x1020E0F0, 0x28464C46, 0x2A000000, 0xFF00FF00, 0x00000000, 0x00000000, 0x001E140A, 
    }},
    {set:{//02 (middle saturation)
        0x00000708, 0x1020E0F0, 0x1E464C46, 0x20000000, 0xFF00FF00, 0x00000000, 0x00000000, 0x001E140A, 
    }},
    ...
    {set:{//04 (middle saturation)
        0x00010709, 0x2850A0FF, 0x1A1E281E, 0x1A000000, 0xFF00FF00, 0x40302000, 0x00400077, 0x00783C1E, 
    }},
    {set:{//05 no one uses this, this is Min Sat.   // low saturation
        0x00010709,	0x2850A0FF,	0x1A232D23,	0x1C000000,	0xFF00FF00,	0x40302000,	0x00000000,	0x00783C1E
    }},
    {set:{//06 no one uses this, this is Max Sat.   // high saturation
        0x00000709,	0x1020E0F0,	0x325A5E5A,	0x32000000,	0xFF00FF00,	0x00000000,	0x00000000,	0x001E140A
    }}
}, 
Contrast:{
    //..........................................................................
...
CCM:{
    ...
    {set:{//01
        0x02140508, 0x040C0413, 0x010C0007, 0x004004D7, 0x01960000, 
    }},
    {set:{//02
        0x01E404DA, 0x040A040F, 0x010A0005, 0x003504B1, 0x017C0000, 
    }}
...
Gamma:{
    {set:{//00
      0x3F1A0D03, 0x8A7C6C5A, 0xC0B2A196, 0xE4DCD4CB, 0xFBF8F2EE, 
    }}
}
