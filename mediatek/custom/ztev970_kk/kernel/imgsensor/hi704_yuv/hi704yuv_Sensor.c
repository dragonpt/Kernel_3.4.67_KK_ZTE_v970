...
const HI704_SENSOR_INIT_INFO HI704_Initial_Setting_Info[] =
{
    ...
    {0x61, 0x00},
	{0x62, 0x79},//blue
	{0x63, 0x81},//red//7c-83 2013.1.25
	{0x64, 0x48},
	{0x66, 0x90},
	{0x67, 0x36},//43->36 2013.1.25
...
void HI704_night_mode(kal_bool enable)
{
    ...
    else 
    {
		...
		HI704_write_cmos_sensor(0x88, 0x03);
		HI704_write_cmos_sensor(0x89, 0x80);
		HI704_write_cmos_sensor(0x8a, 0x7c);
...
{  	   
    ...
    HI704_write_cmos_sensor(0x48, 0x84);//7c	
    HI704_write_cmos_sensor(0x62, 0x79);//70//80->75 2013.1.25
    HI704_write_cmos_sensor(0x63, 0x81);//75//80->85 2013.1.25
    HI704_write_cmos_sensor(0x67, 0x67);//43

    HI704_write_cmos_sensor(0x03, 0x11);
    HI704_write_cmos_sensor(0x60, 0x30);
    HI704_write_cmos_sensor(0x61, 0xa2);
    HI704_write_cmos_sensor(0x67, 0xa0);
    HI704_write_cmos_sensor(0x68, 0x30);	

    HI704_write_cmos_sensor(0x03, 0x13);
    HI704_write_cmos_sensor(0x20, 0x05);//SHARPENESS Black//7//6->5 2013.1.25
    HI704_write_cmos_sensor(0x21, 0x03);//SHARPENESS White //4->3 2013.1.25
    HI704_write_cmos_sensor(0x90, 0x02);
    HI704_write_cmos_sensor(0x91, 0x01);
...
{  	   
    HI704_write_cmos_sensor(0x03, 0x10);
    HI704_write_cmos_sensor(0x48, 0x84);//78
    HI704_write_cmos_sensor(0x62, 0x79);//80//80->78 2013.1.25
    HI704_write_cmos_sensor(0x63, 0x81);//70//80->85 2013.1.25
    HI704_write_cmos_sensor(0x67, 0x36);

    HI704_write_cmos_sensor(0x03, 0x11);
    HI704_write_cmos_sensor(0x60, 0x10);
    HI704_write_cmos_sensor(0x61, 0x82);
    HI704_write_cmos_sensor(0x67, 0xA0);
    HI704_write_cmos_sensor(0x68, 0x30);	

    HI704_write_cmos_sensor(0x03, 0x13);
    HI704_write_cmos_sensor(0x20, 0x06);//7//2013.1.25
    HI704_write_cmos_sensor(0x21, 0x04);//5//2013.1.25
    HI704_write_cmos_sensor(0x90, 0x04);
...
BOOL HI704_set_param_effect(UINT16 para)
{
   SENSORDB("[Enter]HI704 set_param_effect func:para = %d\n",para);
    ...
    case MEFFECT_OFF:
        ...
        HI704_write_cmos_sensor(0x03, 0x13);
        HI704_write_cmos_sensor(0x20, 0x05);//6->5 2013.1.25
...
BOOL HI704_set_param_exposure(UINT16 para)
{
    ...
    case AE_EV_COMP_00:  // +0 EV
		HI704_write_cmos_sensor(0x40,0x87);//88->87
        break;    
