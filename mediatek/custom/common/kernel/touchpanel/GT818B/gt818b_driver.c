...
static int touch_key_array[TPD_VIRTUAL_KEY_MAX]={KEY_MENU, KEY_HOMEPAGE, KEY_BACK, KEY_SEARCH};
...
#define TPD_KEYS_DIM            {{108,1006,40,40},{216,1006,40,40},{324,1006,40,40},{432,1006,40,40}}
#else
// look file: /mediatek/custom/newmann1/kernel/touchpanel/GT818B/tpd_custom_GT818B.h
#endif
...
void tpd_reset_fuc(struct i2c_client *client)
{
    ...
    //DC-hwPowerDown(MT65XX_POWER_LDO_VGP,  "TP");
	msleep(20);
	
    //power on, need confirm with SA
    hwPowerOn(MT65XX_POWER_LDO_VGP2, VOL_2800, "TP");
    //DC-hwPowerOn(MT65XX_POWER_LDO_VGP, VOL_1800, "TP");
...
/*
		...
		*/
		...
		//DC-i2c_write_dummy( i2c_client, TPD_HANDSHAKING_END_REG );
        continue;
        }
