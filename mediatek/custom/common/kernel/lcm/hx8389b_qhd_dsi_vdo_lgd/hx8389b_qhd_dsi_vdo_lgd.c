...
static void lcm_init(void)
{
    ...
    pmic_config_interface(0x9E, 0x51, 0x71, 0x0); /* 3.0V in CAMD */
    pmic_config_interface(0xA1, 0x21, 0x71, 0x0); /* 1.8V in CAM_IO */
    pmic_config_interface(0xCB, 0x31, 0x31, 0x0); /* 2.8V in CAMA */
    mdelay(5);
    pmic_config_interface(BANK0_DIGLDO_CON1C, 0x7, BANK_0_RG_VCAMD_VOSEL_MASK, BANK_0_RG_VCAMD_VOSEL_SHIFT);
    mdelay(5);
    pmic_config_interface(0x9E, 0x51, 0x71, 0x0); /* 3.0V in CAMD */
...
LCM_DRIVER hx8389b_qhd_dsi_vdo_lgd_lcm_drv = 
{
    .name			= "hx8389b_qhd_dsi_vdo_lgd_lcm",
