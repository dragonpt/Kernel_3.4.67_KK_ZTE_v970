...
#define SENSOR_DOES_NOT_EXIST     0xFFFFFFFF
#define SENSOR_DOES_NOT_KNOW      0x00FFFFFF
...
typedef enum
{
  ...
  SENSOR_FEATURE_SET_REGISTER_W_ID,
  SENSOR_FEATURE_GET_REGISTER_W_ID,
  SENSOR_FEATURE_ENABLE_AUTO_CONV,
  SENSOR_FEATURE_SET_TILT,
  SENSOR_FEATURE_SET_ROTATE,
  SENSOR_FEATURE_SET_LINE_START,
...
typedef struct
{
  ...
  MUINT32 RegData;
  MUINT32 ID;
} ACDK_SENSOR_REG_W_ID_INFO_STRUCT;
